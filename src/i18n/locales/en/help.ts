...
export default {
  ...
  navigate_h: "Navigate",
  navigate_p:
    "Scroll or drag to move; <kbd>⌘</kbd>+scroll (or <kbd>+</kbd>/<kbd>-</kbd>) to zoom. <kbd>⌘K</kbd> opens the command palette. <kbd>⌘F</kbd> searches code, <kbd>⌘⇧F</kbd> searches commit content. <kbd>⌘⇧H</kbd> jumps to HEAD, <kbd>⌘⇧U</kbd> to Uncommitted changes. <kbd>⌘\\</kbd> toggles focus mode. Press <kbd>?</kbd> for every shortcut.",
  commits_h: "Commits",
  commits_p:
